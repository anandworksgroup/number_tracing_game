...
// Release signing: create android/key.properties (see flutter_app/README.md).
...
android {
    namespace = "com.anandworksgroup.number_tracing_game"
    ...
    defaultConfig {
        applicationId = "com.anandworksgroup.number_tracing_game"
